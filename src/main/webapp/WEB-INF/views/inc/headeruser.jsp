	...
	<nav class="navbar navbar-static-top">
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				<c:if test="${not empty musterigirisiyok }">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <c:if
							test="${not empty musterigirisivar}">
							<c:forEach var="musteribilgi" items="${musterigirisivar}">
								<img src='<s:url value="/resources/userimage/ee.jpg"></s:url>'
									class="user-image" alt="User Image">
								<span class="hidden-xs"><c:out value="${musteribilgi}"></c:out></span>
								<li class="dropdown tasks-menu"><a
									href='<s:url value="/cikisyap"></s:url>'> <i
										class="fa fa-sign-in" aria-hidden="true"></i><span>Çıkış
											Yap!</span>
								</a></li>
							</c:forEach>
